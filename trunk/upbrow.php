  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="1">
    <tr> 
      <td><a href="report.php">
        <?php echo "<img src=\"images/$shipinfo[image]\" border=0 align=left width=60 height=45>$towedimage"; ?>
        </a></td><td align=top>
      Turns available:<br>
        <b>
...
if($num_planets > 0)
{
  ...
  while($i < $num_planets)
  {
    ...
    echo "<img src=\"images/$planettypes[$planetlevel]\" border=0 width=60 height=68></a><BR><font size=", $basefontsize + 1, " color=#ffffff face=\"arial\">";
...
if($playerinfo[sector] != 0)
{
    ...
    while(!$result4->EOF)
    {
		...
		if ($targetship[player_id]==0) {
			echo "<a href=ship.php?kk=".date("U")."&ship_id=$targetship[ship_id]><img src=\"images/", $targetship[image],"\" border=0 width=60 height=45></a><BR><font size=", $basefontsize +1, " color=#ffffff face=\"arial\">$targetship[ship_name]<br>(Unowned)<br></font>";
			$totalcount++;
        } else { 	
			...
			if($roll < $success)
			{
				if ($targetship[team_name]) {
					echo "<a href=ship.php?kk=".date("U")."&ship_id=$targetship[ship_id]><img src=\"images/", $targetship[image],"\" border=0 width=60 height=45></a><BR><font size=", $basefontsize +1, " color=#ffffff face=\"arial\">$targetship[ship_name]<br>($targetship[character_name])&nbsp;(<font color=#33ff00>$targetship[team_name]</font>)</font>";
				}
				else
				{
					echo "<a href=ship.php?kk=".date("U")."&ship_id=$targetship[ship_id]><img src=\"images/", $targetship[image],"\" border=0 width=60 height=45></a><BR><font size=", $basefontsize +1, " color=#ffffff face=\"arial\">$targetship[ship_name]<br>($targetship[character_name])</font>";
				}
				...
				if ($targetship[tow] > 0) {
					...
					echo "<br><a href=ship.php?kk=".date("U")."&ship_id=$targetship[ship_id]><img src=\"images/", $towedship[image],"\" border=0 width=60 height=45></a><BR><font size=", $basefontsize +1, " color=#ffffff face=\"arial\">$towedship[ship_name]<br>(towed by $targetship[character_name])</font>";
				}
				echo "<br>";
...
if($num_defences > 0)
{
  ...
  while($i < $num_defences)
  {
    ...
    {
       echo "<a href=modify-defences.php?kk=".date("U")."&defence_id=$defence_id><img src=\"images/fighters.gif\" border=0 width=60 height=45></a><BR><font size=", $basefontsize + 1, " color=#ffffff face=\"arial\"><BR>";
       $def_type = $l_fighters;
    ...
    {
       echo "<a href=modify-defences.php?kk=".date("U")."&defence_id=$defence_id><img src=\"images/mines.gif\" border=0 width=60 height=45></a><BR><font size=", $basefontsize + 1, " color=#ffffff face=\"arial\">";
       $def_type = $l_mines;
    }
...
<center><img src="images/lcorner.gif" width="8" height="11" border="0" alt=""><b> 
      ...
      <table border=1 cellpadding=1 cellspacing=0 bgcolor="<? echo $color_line1; ?>" align="center" >
        <tr>
      ...
      <?php
			...
			/********* Corperate planet traderoute type query ******** end **********/
			  ...
			  if($num_traderoutes == 0)
				echo "<center><a >&nbsp;$l_none &nbsp;</a></center>";
			  else
			  {
				$i=0;
				while($i<$num_traderoutes)
				{
				  echo "&nbsp;<a  href=traderoute.php?kk=".date("U")."&engage=" . $traderoutes[$i][traderoute_id] . ">";
...
<TABLE BORDER=1 CELLPADDING=1 CELLSPACING=0 BGCOLOR="<? echo $color_line1; ?>" align="center">
<TR><TD>
&nbsp;<a  href="rsmove.php?kk=<? echo date("U")?>&engage=1&destination=<? echo $playerinfo[preset1]; ?>">=&gt;&nbsp;<? echo $playerinfo[preset1]; ?></a>&nbsp;<a  href=preset.php>[<? echo $l_set?>]</a>&nbsp;</td></tr><TR><TD>
&nbsp;<a  href="rsmove.php?kk=<? echo date("U")?>&engage=1&destination=<? echo $playerinfo[preset2]; ?>">=&gt;&nbsp;<? echo $playerinfo[preset2]; ?></a>&nbsp;<a  href=preset.php>[<? echo $l_set?>]</a>&nbsp;</td></tr><TR><TD>
&nbsp;<a  href="rsmove.php?kk=<? echo date("U")?>&engage=1&destination=<? echo $playerinfo[preset3]; ?>">=&gt;&nbsp;<? echo $playerinfo[preset3]; ?></a>&nbsp;<a  href=preset.php>[<? echo $l_set?>]</a>&nbsp;</td></tr><TR><TD>
&nbsp;<a  href="rsmove.php?kk=<? echo date("U")?>&engage=1&destination=<? echo $playerinfo[preset4]; ?>">=&gt;&nbsp;<? echo $playerinfo[preset4]; ?></a>&nbsp;<a  href=preset.php>[<? echo $l_set?>]</a>&nbsp;</td></tr><TR><TD>
&nbsp;<a  href="rsmove.php?kk=<? echo date("U")?>&engage=1&destination=<? echo $playerinfo[preset5]; ?>">=&gt;&nbsp;<? echo $playerinfo[preset5]; ?></a>&nbsp;<a  href=preset.php>[<? echo $l_set?>]</a>&nbsp;</td></tr><TR><TD>
&nbsp;<a  href="rsmove.php?kk=<? echo date("U")?>&engage=1&destination=<? echo $playerinfo[preset6]; ?>">=&gt;&nbsp;<? echo $playerinfo[preset6]; ?></a>&nbsp;<a  href=preset.php>[<? echo $l_set?>]</a>&nbsp;</td></tr><TR><TD>
&nbsp;<a  href="rsmove.php?kk=<? echo date("U")?>">=&gt;&nbsp;<? echo $l_main_other;?></a>
</td></tr>
</table>
...
<TABLE BORDER=1 CELLSPACING=0 CELLPADDING=0 BGCOLOR="<? echo $color_line1; ?>" align="center">

<TR><TD>
<?
if (!strstr($playerinfo[subscribed],"payment")) {
	echo "&nbsp;<a  href=subscribe.php?kk=".date("U").">Subscribe</a>&nbsp;<br>";
}
?>
&nbsp;<a  href="tell.php?kk=<? echo date("U")?>">Tell A Friend</a>&nbsp;<br>
&nbsp;<a  href="device.php?kk=<? echo date("U")?>"><? echo $l_devices ?></a>&nbsp;<br>
&nbsp;<a  href="planet-report.php?kk=<? echo date("U")?>">Planet Report</a>&nbsp;<br>
&nbsp;<a  href="ships-report.php?kk=<? echo date("U")?>">Ships Report</a>&nbsp;<br>
&nbsp;<a  href="log.php?kk=<? echo date("U")?>"><? echo $l_log ?></a>&nbsp;<br>
&nbsp;<a  href="defence-report.php?kk=<? echo date("U")?>"><? echo $l_sector_def ?></a>&nbsp;<br>
&nbsp;<a  href="readmail.php?kk=<? echo date("U")?>"><? echo $l_read_msg ?></A>&nbsp;<br>
&nbsp;<a  href="mailto2.php?kk=<? echo date("U")?>"><? echo $l_send_msg ?></a>&nbsp;</td>
<td>
&nbsp;<a  href="ranking.php?kk=<? echo date("U")?>"><? echo $l_rankings ?></a>&nbsp;<br>
&nbsp;<a  href="teams.php?kk=<? echo date("U")?>"><? echo $l_teams ?></a>&nbsp;<br>
&nbsp;<a  href="self-destruct.php?kk=<? echo date("U")?>"><? echo $l_ohno ?></a>&nbsp;<br>
&nbsp;<a  href="options.php?kk=<? echo date("U")?>"><? echo $l_options ?></a>&nbsp;<br>
&nbsp;<a  href="navcomp.php?kk=<? echo date("U")?>"><? echo $l_navcomp ?></a>&nbsp;<br>
<?
if ($ksm_allowed == true)
{
echo "&nbsp;<a  href=galaxy2.php?kk=".date("U").">$l_map</a>&nbsp;<br>";
}
?>
</td></tr>
<tr><td colspan=2 align=center>
<div >
<? //&nbsp;<a  href="help.php">$l_help</a>&nbsp;<br> ?>
&nbsp;<a  href="faq.html">FAQ</a>&nbsp;<br>
&nbsp;<a  href="help.php">Help</a>&nbsp;<br>
&nbsp;<a  href="feedback.php"><? echo $l_feedback ?></a>&nbsp;<br>
<?
if(!empty($link_forums))
{
    echo "&nbsp;<a  href=\"$link_forums\" TARGET=\"_blank\">$l_forums</a>&nbsp;<br>";
}
?>
<a  href="logout.php"><? echo $l_logout ?></a>
</div>
</td></tr>
</table>
<?
