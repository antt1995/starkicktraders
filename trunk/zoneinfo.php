...
else
{
  ...
  echo "<table border=1 cellspacing=1 cellpadding=0 width=\"100%\" align=center>" .
       ...
       "<tr bgcolor=$color_line1><td><font color=white size=3>&nbsp;$l_att_att</font></td><td><font color=white size=3>$attack&nbsp;</font></td></tr>" .
       "<tr bgcolor=$color_line2><td><font color=white size=3>&nbsp;$l_md_title</font></td><td><font color=white size=3>$defense&nbsp;</font></td></tr>" .
       "<tr bgcolor=$color_line1><td><font color=white size=3>&nbsp;$l_warpedit</font></td><td><font color=white size=3>$warpedit&nbsp;</font></td></tr>" .
       "<tr bgcolor=$color_line2><td><font color=white size=3>&nbsp;Planets</font></td><td><font color=white size=3>$planet&nbsp;</font></td></tr>" .
       "<tr bgcolor=$color_line1><td><font color=white size=3>&nbsp;$l_title_port</font></td><td><font color=white size=3>$trade&nbsp;</font></td></tr>" .
       "<tr bgcolor=$color_line2><td><font color=white size=3>&nbsp;$l_zi_maxhull</font></td><td><font color=white size=3>$hull&nbsp;</font></td></tr>" .
       "</table>" .
       "</td></tr>" .
       "</table>";
}
